# Friday Fight Funkin' credits

The Friday Fight Funkin' credits follow `CreditsState.hx` from Friday Night Funkin' 0.8.6.
...
`unity-party.json` preserves the original Unity Party section after the Friday Fight Funkin' rename.
