...
namespace Unity.RemoteConfig.Editor.UIComponents
{
    ...
    public class SegmentationRulesTreeview
    {
        ...
        public SegmentationRulesTreeview(string addSettingButtonText = "Add Setting", string keyColumnHeader = "Key", string valueColumnHeader = "Value")
        {
            ...
            treeView = new SegRulesTreeview(new TreeViewState<int>(), new SegmentationRulesTreeviewMultiColumnHeader(CreateSettingsMultiColumnHeaderState(), false), new JArray(), new JArray());
    ...
    internal class SegRulesTreeview : TreeView<int>
    {
        public JArray settingsList;
        public JArray activeSettingsList;
        public JArray rulesList;
        ...
        public SegRulesTreeview(TreeViewState<int> state, MultiColumnHeader multiColumnHeader, JArray settingsList,
